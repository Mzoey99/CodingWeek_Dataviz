...
regions = ['tahiti','provence','champagne','corse','guadeloupe', 'normandie','centre','lorraine','bretagne','reunion','languedoc','picardie','calais','poitou', 'azur', 'pierre','franche','midi','guyan','loire','bourgogne', 'limousin','ile de','martinique','mayotte','orleanais','alsace','aquitaine','caledonie','roussillon','rhone','savoie']
...
def main(): 
    ...
    annotations_blob = annotateTextblob(info_textblob, regions, miss, missNames)
